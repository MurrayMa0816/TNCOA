...
from src.algo.intrinsic_rewards.tncoa import DiscriminatorModel
from src.algo.intrinsic_rewards.icm import ICMModel
from src.algo.intrinsic_rewards.ride import RIDEModel
...
class PPOModel(ActorCriticCnnPolicy):
    def __init__(
        ...
        n_steps: int = 0,
        int_rew_source: ModelType = ModelType.TNCOA,
        ...
        if self.int_rew_source == ModelType.RIDE:
            self.int_rew_model = RIDEModel(
                icm_forward_loss_coef=self.icm_forward_loss_coef,
                **int_rew_model_kwargs,
        )
